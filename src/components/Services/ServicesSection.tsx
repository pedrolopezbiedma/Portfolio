...
import { brainwaveServices, brainwaveServicesIcons } from '../../content';
import Generating from '../Hero/Generating';
import Heading from '../shared/Heading';
import Section from '../shared/Section';
import { Gradient, PhotoChatMessage, VideoBar, VideoChatMessage } from './Services';
						...
						<div className='relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden'>
							...
							<div className='absolute  inset-0 flex flex-col justify-end p-8 bg-gradient-to-b from-n-8/0 to-n-8/90 lg:p-15'>
								...
								<p className='body-2 mb-[3rem] text-n-3'>
									Automatically enhance your photos using our AI apps photo editing feature. Try it now!
								</p>
							</div>
							<PhotoChatMessage />
						</div>
